...
> LogCLI: CLI log viewer with filtering, search, and tail from remote sources
...
## 🏗️ Architecture
Three-tier architecture: Python, Typer backend, native frontend, PostgreSQL database. Containerized with Docker.
...
git clone https://github.com/elitsuri/logcli
cd logcli
